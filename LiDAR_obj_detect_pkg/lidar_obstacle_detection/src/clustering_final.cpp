...
public:
    ...
    inline void set_msg(sensor_msgs::PointCloud2& in_msg){
        points_msg = in_msg;
...
private:
    ...
    // std::vector<sensor_msgs::PointCloud2> cluster_point;
...
public:
    QuadTree() : seq(0){
        ...
        ROS_INFO("  correction_eps = %f", correction_eps);
        ROS_INFO("==========================================");
